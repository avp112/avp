...
print ' <form method="POST" action="leitstelle.php?aktion=5_storno"> ';
      // Tabellenüberschrift
 echo " <body bgcolor=#6B0000>
<table border=0>
    <tr>

    <td bgcolor=D20D02 width=\"365\" align=\"center\" colspan=\"5\">Status 0 und 5</a></td> 
    </tr>
...
$ergebnis = mysql_query('SELECT  `frn` , `kruz` , `so_b`, `fhztyp`,`titel`,`Zeit` , `status_fhr` , `status_lst` ,`status_fhr_save` FROM `'.$mysql_prefix.'fahrzeuge` WHERE (`status_fhr` = "5" or `status_fhr` = "0"  )  ORDER BY `status_fhr` ASC,`Zeit` ASC;' );
...
print '<div style="visibility: hidden; top:1mm; left:1mm; z-index:1"  >';
print '<p><iframe name="I1" src="./sound/sprechwunsch.php" height="0" width="0" border="0" frameborder="0">';
print '</iframe></p>';
print '</div>';
}
...
elseif ($status_fhr == "0" )
{   
echo "<td align=\"center\" bgcolor=$col1><font color=\"#FFFFFF\"><a class=\"buttons\" a href=\"?aktion=status_5_storno&auto=$frn&oldst=$status_fhr_save\" ; return false><span>$status_fhr</a></span></font></td>";

//echo "<td align=\"center\" bgcolor=$col1><a class=\"buttons\"; return false><span>$status_fhr</span></td>";
print '<div style="visibility: hidden; top:1mm; left:1mm; z-index:1"  >';
print '<p><iframe name="I1" src="./sound/notruf.php" height="0" width="0" border="0" frameborder="0">';
print '</iframe></p>';
print '</div>';

...
<table border=0>
    ...
    <td bgcolor=D20D02 width=\"365\" align=\"center\" colspan=\"5\">Löschzug 1</a></td> 
    </tr>
...
$ergebnis = mysql_query('SELECT  `frn` , `kruz` , `so_b`, `fhztyp`,`titel`,`Zeit` , `status_fhr` , `status_lst` ,`status_fhr_save` FROM `'.$mysql_prefix.'fahrzeuge` WHERE (`so_b` = "1" and ( `status_fhr` != "'.$statussichtbar.'" and `status_fhr` != "5" ))  ORDER BY `frn` ASC;');
